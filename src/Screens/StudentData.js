...
//                     <Typography marginLeft={160} fontWeight="bold" fontSize={27} marginTop={-5.2}>Contact</Typography>
//                 </Box>
//                 <Button onClick={() => { navigate('/StudentForm') }} variant="contained" sx={{ borderRadius: "20px", fontWeight: "bold", color: "whitesmoke", fontSize: "16px", marginLeft: "87em", marginTop: "0.8em",
//                  marginBottom: "0.8em" }} color="success" ><AddIcon />New</Button>
//                 {data.map((x, i) => (
...
//       fontFamily="monospace" fontSize={20}>1/3</Typography>
//       <Button>
//         Next Page
//       </Button>
//         </div>
